...
export const MISTAKE_TEMPLATES_ES: MistakeTemplate[] = [
  ...
  },
  {
    ...
    explanation: "Arriesgar el 50% del capital en una sola operación es suicida. Una sola pérdida corta la cuenta a la mitad. Y para volver a 500€, habrá que hacer +100% sobre el capital restante.",
    lessons: {
      advanced:     "La regla de oro pro: 0,5 a 2% del capital por operación según el tamaño de la cuenta. Más allá del 5%, ya no es trading, es apuesta.",
      intermediate: "El tamaño de posición es la variable nº1 del money management. Un setup correcto + un lote demasiado grande = cuenta muerta. La regla: en 500€, nunca más del 5% por operación (es decir 25€ máx. de riesgo).",
      beginner:     "La regla de referencia: 5% máx en cuenta de 200-500€, 3% en 500-1000€, 2% en 1000-5000€. El apalancamiento de tu broker no importa, lo que cuenta es cuánto pierdes en euros si tocan tu SL.",
    },
    difficulties: ["intermediate", "advanced"],
  ...
  },
  {
    ...
    explanation: "En una news mayor (NFP, FOMC, CPI), el spread puede ampliarse x5 a x10, y el precio puede hacer un movimiento instantáneo que salta el SL. La regla pro: dividir el tamaño del lote por 2 o 3 en los 30 minutos alrededor de una news roja, o no tradear directamente.",
    lessons: {
      advanced:     "Los algos institucionales cortan su exposición antes de las news por la misma razón: la price action se vuelve binaria e impredecible. Mantener un tamaño normal = apostar al azar.",
      intermediate: "Una news mayor puede mover un par 50-100 pips en 1 segundo. Tu SL se vuelve teórico porque el slippage te saca 20-30 pips más lejos. Reducir el tamaño protege tu cuenta.",
  ...
  },
  {
    ...
    explanation: "En FOMC + Powell, XAU puede hacer 50-100$ de amplitud en algunos minutos. Tu SL estándar será atravesado por slippage. O cortas la posición antes del anuncio, o reduces el lote, o pones un SL muy amplio para absorber la vol.",
    lessons: {
      advanced:     "El risk management institucional impone neutralizar la exposición antes de todo evento con pricing power. Sobre Powell, incluso los buenos setups quedan a merced de una frase mal interpretada.",
      intermediate: "Una posición dejada al descubierto durante un evento macro = apuesta binaria. El setup técnico pierde todo valor frente a un titular fuerte. O sales, o aceptas apostar.",
  ...
  },
  {
    ...
    decoyMistakes: ["stop_too_tight", "oversized_position", "bad_rr"],
    explanation: "Cuando la volatilidad se duplica, tu riesgo efectivo también se duplica a tamaño de lote constante. Un SL de 30$ que aguantaba en un ATR de 35$ va a saltar fácilmente en un ATR de 80$. Adaptar el tamaño a la vol = principio básico del risk management.",
    lessons: {
      advanced:     "El position sizing dinámico se calcula sobre el ATR: tamaño = (capital × riesgo%) / (ATR × multiplicador SL). Cuando el ATR se duplica, el tamaño debe dividirse por 2 para conservar el mismo riesgo.",
      intermediate: "Los buenos traders ajustan su lote según la volatilidad del día. Un ATR 2x superior al normal = lote dividido por 2 o SL duplicado. Si no, el riesgo real se vuelve incontrolable.",
  ...
  },
  {
    ...
    decoyMistakes: ["stop_too_tight", "oversized_position", "trade_before_news"],
    explanation: "El fin de semana, los mercados FX están cerrados pero el mundo sigue. Una news geopolítica mayor (declaración banco central, conflicto, elección) puede crear un gap a la apertura del domingo que salta tu SL de 50 a 200 pips. El slippage de fin de semana no es negociable.",
    lessons: {
      advanced:     "Los hedge funds salen generalmente de sus posiciones FX direccionales antes del close del viernes, o se cubren vía opciones. Mantener una exposición naked en el fin de semana = apuesta a la actualidad geopolítica.",
      intermediate: "Antes de un fin de semana, dos opciones: salir de tus posiciones, o reducir fuertemente el tamaño. El gap de apertura del domingo puede ser brutal y tu SL no te protege durante el cierre.",
