    ...
    lessons: [
      ...
      // ─── Leçon 1 ────────────────────────────────────────────────────────────
      {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "Cas 1 — tu gagnes : Le Bitcoin est à 20 000 €. Tu analyses et tu penses qu'il va monter. Tu achètes. Il monte à 22 000 €. Tu vends. Tu gagnes 2 000 € par Bitcoin. Cas 2 — tu perds : Le Bitcoin est à 20 000 €. Tu achètes. Il descend à 18 500 €. Tu paniques et tu vends. Tu perds 1 500 € par Bitcoin. La différence entre les deux cas ? Pas l'analyse — le comportement face à la perte.",
            diagram: "trade",
            items: [
        ...
        quiz: {
          question: "Tu achètes du Bitcoin à 20 000 € et tu le revends à 21 500 €. Combien gagnes-tu par Bitcoin ?",
          answers: [
            "21 500 € — le prix auquel tu l'as vendu",
            "20 000 € — le prix auquel tu l'as acheté",
            "1 500 € — la différence entre vente et achat",
            "On ne peut pas savoir sans connaître la mise de départ",
          ],
          correct: 2,
          explanation:
            "En trading, le gain = prix de vente - prix d'achat. Ici : 21 500 - 20 000 = 1 500 € par Bitcoin. C'est la règle de base, toujours la même. Tu gagnes uniquement la différence — pas le prix total de vente.",
          answerExplanations: [
            "Faux. 21 500 € c'est le prix de revente total — pas ton gain. Tu avais dépensé 20 000 € pour acheter. Ton gain réel, c'est ce que tu récupères en PLUS de ta mise : 21 500 - 20 000 = 1 500 €.",
            "Faux. 20 000 € c'est le prix d'achat — ton coût d'entrée, pas un gain. Si tu avais revendu à 20 000 €, tu aurais récupéré exactement ta mise, sans rien gagner ni perdre.",
            "Correct. Gain = prix de vente - prix d'achat = 21 500 - 20 000 = 1 500 € par Bitcoin. C'est le principe fondamental du trading : tu gagnes la différence entre où tu es entré et où tu es sorti.",
            "Faux. La mise de départ (combien de Bitcoin tu as acheté) change le gain TOTAL en euros, mais pas le gain PAR Bitcoin. Par unité, le calcul est toujours : prix de vente - prix d'achat = 1 500 €.",
          ],
        },
      },
      ...
      // ─── Leçon 2 ────────────────────────────────────────────────────────────
      {
        ...
        sections: [
          {
            ...
            items: [
              "L'or est à 1 900 €. Tu penses qu'il va monter. Tu achètes (Long).",
              "L'or monte à 2 000 €. Tu revends. Tu gagnes 100 € par once.",
              "Si l'or descend à 1 820 € et que ton Stop Loss se déclenche, tu perds 80 € par once.",
          ...
          },
          {
            ...
            items: [
              "L'or est à 2 000 €. Tu penses qu'il va baisser. Tu vends (Short).",
              "L'or descend à 1 900 €. Tu rachètes. Tu gagnes 100 € par once.",
              "Si l'or monte à 2 080 € et que ton Stop Loss se déclenche, tu perds 80 € par once.",
        ...
        exercise: {
          ...
          steps: [
            ...
            "Si tu avais ouvert un Short au début de cette baisse, combien aurais-tu gagné par Bitcoin ?",
          ],
        },
        quiz: {
          question: "Le Bitcoin est à 30 000 €. Tu penses qu'il va baisser à 27 000 €. Quel ordre ouvres-tu ?",
          answers: [
          ...
          correct: 1,
          explanation:
            "Pour profiter d'une baisse anticipée, tu ouvres un Short (Sell). Tu vends à 30 000 € et tu rachètes à 27 000 €. Tu gagnes la différence : 3 000 € par Bitcoin. Le Short te permet de gagner quand le marché descend.",
          answerExplanations: [
            "Faux. Un Long (Buy) = parier sur une HAUSSE. Si tu penses que le Bitcoin va baisser et tu ouvres un Long, tu perdras quand le prix descend à 27 000 € — exactement l'inverse de ce que tu voulais.",
            "Correct. Un Short (Sell) = parier sur une BAISSE. Tu vends à 30 000 €, le prix descend à 27 000 €, tu rachètes. Gain = 30 000 - 27 000 = 3 000 € par Bitcoin. C'est la logique du Short.",
      ...
      // ─── Leçon 6 ────────────────────────────────────────────────────────────
      {
        ...
        sections: [
          {
            heading: "Le principe, en une phrase",
            body: "Un Take Profit (TP), c'est un ordre automatique qui ferme ton trade et encaisse ton gain dès que le prix atteint ton objectif. Tu définis l'objectif avant d'entrer — le broker exécute tout seul quand le prix y arrive, que tu sois devant l'écran ou non.",
            diagram: "takeprofit",
            items: [
              "Long : ton TP est placé AU-DESSUS de ton prix d'entrée",
              "Short : ton TP est placé EN-DESSOUS de ton prix d'entrée",
              "Exemple : tu achètes Bitcoin à 30 000 €. Tu places un TP à 33 000 €.",
              "Quand le Bitcoin touche 33 000 €, le trade se ferme — tu gagnes 3 000 € par Bitcoin",
            ],
          },
          {
            heading: "Exemple concret — gain et perte avec et sans TP",
            body: "Cas 1 — avec Take Profit : Tu achètes Bitcoin à 30 000 €. Tu places un TP à 33 000 €. Le prix monte à 33 000 €. Le trade se ferme automatiquement. Tu gagnes 3 000 € par Bitcoin. Même si le prix redescend ensuite à 28 000 €, ton gain est sécurisé.\n\nCas 2 — sans Take Profit : Tu achètes Bitcoin à 30 000 €. Le prix monte à 33 000 €. Tu regardes et tu gardes 'parce que ça monte encore'. Le prix redescend à 29 000 €. Tu paniques et tu fermes. Tu perds 1 000 € — alors que tu étais à +3 000 €.",
            items: [
              "Avec TP : le gain est encaissé automatiquement, sans émotion",
              "Sans TP : l'émotion décide quand sortir — presque toujours au mauvais moment",
              "Un trade qui était à +3 000 € peut finir à -1 000 € si tu n'as pas de TP",
            ],
          },
          {
            heading: "Le ratio Risque / Récompense (R/R)",
            body: "Le R/R compare ce que tu risques (SL) et ce que tu vises (TP). C'est la métrique la plus importante en gestion du risque. Elle détermine si ta stratégie est rentable sur le long terme — indépendamment de ton taux de réussite.",
            table: {
              headers: ["Ratio R/R", "Exemple concret", "Ce que ça permet"],
              rows: [
                ["1:1", "Risque 500 €, vise 500 €", "Il faut gagner 1 trade sur 2 pour être rentable"],
                ["1:2", "Risque 500 €, vise 1 000 €", "Tu peux perdre 2 trades sur 3 et rester positif"],
                ["1:3", "Risque 500 €, vise 1 500 €", "Tu peux perdre 3 trades sur 4 et rester positif"],
              ],
            },
          },
          {
            ...
            items: [
              "Fermer le trade trop tôt par peur : tu es à +500 €, tu fermes. Ensuite le prix va à +1 500 €.",
          ...
          {
            heading: "L'erreur fatale",
            body: "Ne pas avoir de Take Profit et laisser une position gagnante ouverte indéfiniment. Le marché ne monte jamais en ligne droite. Sans TP, tu regardes ton gain de +2 000 € s'éroder progressivement : +2 000, +1 500, +800, +200. Tu attends le rebond. Le rebond ne vient pas. Tu fermes à -500 €. Un trade qui était excellent devient une perte — uniquement parce qu'il n'y avait pas d'ordre pour sécuriser le gain.",
          },
        ],
        keyPoints: [
          "Take Profit = ordre automatique qui ferme ton trade quand tu atteins ton objectif",
          ...
          "Ratio R/R minimum recommandé : 1:2 — tu vises 2 fois ce que tu risques",
        ...
        exercise: {
          ...
          steps: [
            ...
            "Identifie la prochaine résistance au-dessus du prix actuel — note ce niveau en euros.",
            "Imagine une entrée Long au prix actuel avec un SL à 1 000 € en dessous. Pour un R/R de 1:2, ton TP doit être à 2 000 € au-dessus.",
            "La prochaine résistance identifiée est-elle au-delà de ce TP ? Si oui, le setup a un bon potentiel.",
          ],
        },
        quiz: {
          question: "Tu achètes Bitcoin à 30 000 € avec un SL à 29 500 € (500 € de risque). Pour un ratio R/R de 1:2, où place-tu ton TP ?",
          answers: [
            "À 30 250 € — 250 € de gain pour 500 € de risque",
            "À 30 500 € — 500 € de gain, ratio 1:1",
            "À 31 000 € — 1 000 € de gain pour 500 € de risque",
            "Le plus haut possible pour maximiser le gain",
          ],
          correct: 2,
          explanation:
            "Ratio 1:2 = tu vises 2 fois ce que tu risques. SL = 500 € de risque. TP = 500 × 2 = 1 000 € de gain. 30 000 + 1 000 = 31 000 €. Avec ce ratio, tu peux perdre 2 trades sur 3 et rester profitable sur le long terme.",
          answerExplanations: [
            "Faux. 250 € de gain pour 500 € de risque = ratio 1:0,5. Tu risques 2 fois plus que tu ne gagnes. Même avec 70% de trades gagnants, tu serais perdant sur le long terme avec ce ratio.",
            "Faux. 500 € de gain pour 500 € de risque = ratio 1:1. Ce n'est pas suffisant. Il faut gagner plus de 50% de ses trades pour être rentable — ce qui est difficile à tenir durablement.",
            "Correct. 1 000 € de gain pour 500 € de risque = ratio 1:2. C'est le minimum recommandé pour une stratégie saine. Mathématiquement, avec ce ratio, 34% de trades gagnants suffisent pour être en profit global.",
            "Faux. Viser 'le plus haut possible' sans objectif défini, c'est trader sans plan. Un TP trop éloigné ne sera jamais atteint — tu regarderas le prix monter, atteindre ta zone, puis redescendre sans avoir encaissé.",
          ],
        },
      },
      ...
      // ─── Leçon 7 ────────────────────────────────────────────────────────────
      {
        ...
        duration: "8 min",
        introduction:
          "Tu es en trade, tu gagnes 1 500 €, tu te détends. Le marché fait une correction, revient en arrière, et efface tout ton gain. Le trade se ferme sur ton Stop Loss initial — tu perds 500 € alors que tu étais en profit. C'est évitable. C'est ça que le Break Even corrige.",
        sections: [
          {
            heading: "Le principe, en une phrase",
            body: "Le Break Even (BE), c'est déplacer ton Stop Loss à ton prix d'entrée exact. Si le prix revient en arrière, tu sors à zéro — ni gain, ni perte. Si le prix continue dans ton sens, tu continues à gagner. Ton trade ne peut plus te faire perdre d'argent.",
            diagram: "breakeven",
            items: [
              "Tu achètes Bitcoin à 30 000 € avec un SL initial à 29 000 €",
              "Le Bitcoin monte à 31 000 € (+1 000 € de profit)",
              "Tu déplaces ton SL de 29 000 € à 30 000 € (ton prix d'entrée) — c'est le Break Even",
              "Maintenant : si le Bitcoin redescend à 30 000 €, tu sors à zéro. Si il continue, tu gagnes.",
            ],
          },
          {
            heading: "Exemple concret — avec et sans Break Even",
            body: "Cas 1 — avec Break Even : Tu achètes Bitcoin à 30 000 €, SL à 29 000 €. Le prix monte à 31 000 €. Tu actives le BE (SL → 30 000 €). Le marché fait une correction et redescend à 30 000 €. Sortie automatique. Résultat : 0 € de perte. Et si le prix avait continué à monter à 34 000 €, tu aurais gagné 4 000 €.\n\nCas 2 — sans Break Even : Même trade. Le Bitcoin monte à 31 000 €. Tu ne touches rien. Le marché redescend brutalement à 28 500 €. Ton SL original à 29 000 € ne suffit pas — tu perds 1 000 € alors que tu étais à +1 000 €.",
            items: [
              "Avec BE : le trade ne peut plus perdre d'argent une fois activé",
              "Sans BE : un profit de +1 000 € peut devenir une perte de -1 000 € du jour au lendemain",
              "Le BE te libère du stress — tu peux attendre ton TP sereinement",
            ],
          },
          {
            heading: "Quand activer le Break Even ?",
            body: "Le timing est crucial. Trop tôt, le marché te sort sur une simple fluctuation normale. Au bon moment, le BE te protège vraiment. La règle : attends d'être en profit d'au moins 1R (une fois ton risque initial).",
            table: {
              headers: ["Ton risque (SL)", "Quand activer le BE", "Pourquoi"],
              rows: [
                ["500 €", "Quand tu es à +500 € de profit", "1R atteint — la protection est logique"],
                ["1 000 €", "Quand tu es à +1 000 € de profit", "Avant ça, les fluctuations normales te sortiraient"],
                ["Moins de 1R", "Pas encore — attends", "Le marché fluctue normalement, tu serais sorti inutilement"],
              ],
            },
          },
          {
            ...
            items: [
              "Activer le BE trop tôt (à +50 € de profit sur un SL de 500 €) : la moindre fluctuation te sort à zéro",
          ...
          {
            heading: "L'erreur fatale",
            body: "Activer le Break Even trop tôt sous le stress. Tu es à +200 € de profit sur un SL de 500 €. Tu paniques à l'idée de reperdre. Tu déplaces le SL à ton prix d'entrée. Le marché fluctue normalement de -300 €, déclenche ton BE, et tu sors à zéro. Ensuite, le prix monte à +2 000 €. Tu regardes le trade faire exactement ce que tu avais prévu — sans toi. L'impatience t'a sorti d'un trade gagnant.",
          },
        ],
        keyPoints: [
          "Break Even = déplacer le Stop Loss au prix d'entrée → plus aucun risque de perte",
          "Activer le BE quand le trade est en profit d'au moins 1R (1 fois le risque initial)",
        ...
        exercise: {
          ...
          steps: [
            ...
            "Note l'entrée et le SL logique (juste sous le dernier point bas). Calcule le risque en euros.",
            "À quel moment le prix avait-il atteint +1R de profit ? Note ce niveau — c'est quand tu aurais activé le BE.",
            "Qu'aurait donné le BE activé à ce moment : sortie à zéro ou continuation en profit ?",
          ],
        },
        quiz: {
          question: "Tu achètes Bitcoin à 30 000 € avec un SL à 29 000 € (1 000 € de risque). Le prix monte à 31 000 €. Que fais-tu ?",
          answers: [
            "Tu actives le Break Even : tu déplaces ton SL de 29 000 € à 30 000 €",
            "Tu gardes le SL à 29 000 € — il ne faut jamais déplacer un SL",
            "Tu fermes le trade à 31 000 € pour sécuriser les 1 000 €",
            "Tu déplaces le SL à 30 300 € pour sécuriser 300 € de gain",
          ],
          correct: 0,
          explanation:
            "À 31 000 €, tu es en profit de 1 000 € = exactement 1R (ton risque était de 1 000 €). C'est le bon moment pour activer le BE : tu déplaces le SL de 29 000 € à 30 000 €. Tu ne peux plus perdre d'argent — et si le prix continue à monter vers ton TP, tu continues à gagner.",
          answerExplanations: [
            "Correct. +1 000 € de profit = 1R (risque = 1 000 €). Tu déplaces le SL de 29 000 € à 30 000 €. Le trade ne peut plus perdre d'argent. Si le prix revient à 30 000 €, sortie à zéro. Si il continue à monter, tu continues à gagner.",
            "Faux. Il est parfaitement valide — et même recommandé — de déplacer le SL dans le sens du profit. La règle est de ne jamais déplacer le SL dans le sens de la PERTE. Ici, tu le déplaces vers ton prix d'entrée pour te protéger.",
            "Faux. Fermer à 31 000 € te donne 1 000 € certains, mais tu rates potentiellement un mouvement vers 34 000 € ou 36 000 €. Activer le BE te permet de rester dans le trade sans risque — c'est souvent le meilleur choix.",
            "Faux. Déplacer le SL à 30 300 € (sécuriser 300 €) est une technique appelée 'trailing stop partiel'. C'est différent du Break Even standard qui va exactement au prix d'entrée. Le risque ici est de se faire sortir sur une fluctuation normale de 300 €.",
          ],
        },
      },
