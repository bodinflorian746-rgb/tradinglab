...
export function SpreadDiagram({ className = '' }: SpreadDiagramProps) {
  return (
    <div className={`bg-zinc-950 border border-zinc-800 rounded-xl p-5 space-y-4 ${className}`}>
      ...
      {/* 3 cartes BID / SPREAD / ASK */}
      <div className="grid grid-cols-3 gap-2">
        <div className="bg-blue-500/10 border border-blue-500/40 rounded-xl p-3 text-center">
          <p className="text-[11px] font-bold text-blue-400 uppercase tracking-wider">BID</p>
          <p className="text-2xl font-mono font-bold text-white mt-1">1,0800</p>
        </div>
        <div className="bg-blue-500/10 border border-blue-500/40 rounded-xl p-3 text-center">
          <p className="text-[11px] font-bold text-blue-400 uppercase tracking-wider">SPREAD</p>
          <p className="text-2xl font-mono font-bold text-white mt-1">5 pts</p>
        </div>
        <div className="bg-emerald-500/10 border border-emerald-500/40 rounded-xl p-3 text-center">
          <p className="text-[11px] font-bold text-emerald-400 uppercase tracking-wider">ASK</p>
          <p className="text-2xl font-mono font-bold text-white mt-1">1,0805</p>
        </div>
      </div>
