  ...
  return (
    <div className={`bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden ${className}`}>
      <svg width="100%" viewBox="0 0 700 320" fill="none" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="398" y="42" fill="#ef4444" fontSize="9" fontWeight="600" textAnchor="middle">SL H4 · 1.1790 · 35 pts</text>
        ...
        <text x="398" y="96" fill="#ef4444" fontSize="9" fontWeight="600" textAnchor="middle">SL M5 · 1.1772 · 14 pts</text>
        ...
        <text x="424" y="130" fill="#60a5fa" fontSize="9" fontWeight="600" textAnchor="middle">Entrée 1.1758</text>
      ...
      <div className="flex flex-wrap gap-4 px-4 py-2.5 border-t border-zinc-800/50">
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-sm bg-red-500" />
          <span className="text-[10px] text-zinc-500">SL M5 réduit après confirmation LTF</span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-sm bg-blue-400" />
          <span className="text-[10px] text-zinc-500">Entrée commune aux deux scénarios</span>
        </div>
      </div>
    </div>
  );
