...
const LESSONS = [
  {
    id:          "lecon1",
    number:      1,
    title:       "Pourquoi analyser en multi-timeframe",
    description: "Pourquoi trader un seul graphique rend aveugle, et le rôle de chaque étage : biais, zone, déclencheur.",
    duration:    "16 min",
    href:        "/strategies/multi-timeframe/lecon1",
    disabled:    false,
  },
  {
    id:          "lecon2",
    number:      2,
    title:       "Le timeframe supérieur : définir le contexte et le biais",
    description: "Lire le timeframe supérieur (H4/Daily) : structure, zones, et en sortir un biais directionnel clair.",
    duration:    "18 min",
    href:        "/strategies/multi-timeframe/lecon2",
    disabled:    false,
  },
  {
    id:          "lecon3",
    number:      3,
    title:       "Le timeframe intermédiaire : repérer la zone qui compte",
    description: "Descendre d’un cran : localiser la zone précise où le scénario du HTF peut s’activer.",
    duration:    "18 min",
    href:        "/strategies/multi-timeframe/lecon3",
    disabled:    false,
  },
  {
    id:          "lecon4",
    number:      4,
    title:       "Le timeframe d’exécution : l’entrée précise",
    description: "Le timeframe d’exécution (M5/M15) : attendre le déclencheur dans la zone et entrer avec précision.",
    duration:    "18 min",
    href:        "/strategies/multi-timeframe/lecon4",
    disabled:    false,
  },
  {
    id:          "lecon5",
    number:      5,
    title:       "Le process complet : du Daily au M5 en un trade",
    description: "Dérouler la séquence complète, du Daily au M5, sur un trade réel de A à Z.",
    duration:    "20 min",
    href:        "/strategies/multi-timeframe/lecon5",
    disabled:    false,
  },
];
